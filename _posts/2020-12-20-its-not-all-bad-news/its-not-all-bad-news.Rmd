...
description: |
  While it is true that COVID-19 infections are increasing at an alarming pace across Ohio, the one saving grace may be that the percentage of deaths to infections has also declined. This is an important indicator that Ohio's physicians, nurses and other health care workers have responded effectively to the deadliest challenge of the 21st Century.  
author:
  - name: Orman Hall
